...
1. ✅ Finalizar CPA Dashboard (Fim de Janeiro)
2. ⏳ Começar estudos de integração Omie
3. ⏳ Definir plano de hospedagem (Azure vs GCP)
...
**Próxima Revisão:** Após lançamento do CPA Dashboard
